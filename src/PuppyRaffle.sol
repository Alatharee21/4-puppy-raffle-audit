...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        /// q Why do players have to pay entrance fee * no of players?
        /// s For gas efficiency, newPlayers.length should be assigned to a variable.
        require(
    ...
    function getActivePlayerIndex(
        ...
        ///q This will eventually return zero NO? should be Else {return 0}
        return 0;
    }
